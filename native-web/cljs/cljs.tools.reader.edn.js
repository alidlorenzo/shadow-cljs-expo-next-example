...
var G__42609 = (function (){var G__42546 = sb;
G__42546.append(cljs.tools.reader.reader_types.read_char(rdr));

return G__42546;
})();
var G__42610 = cljs.tools.reader.reader_types.peek_char(rdr);
sb = G__42609;
ch = G__42610;
continue;
}
...
var temp__5733__auto____$2 = (function (){var G__42547 = (function (){var G__42550 = rdr;
cljs.tools.reader.reader_types.unread(G__42550,ch);

return G__42550;
})();
var G__42548 = ch;
var G__42549 = opts;
return (cljs.tools.reader.edn.read_tagged.cljs$core$IFn$_invoke$arity$3 ? cljs.tools.reader.edn.read_tagged.cljs$core$IFn$_invoke$arity$3(G__42547,G__42548,G__42549) : cljs.tools.reader.edn.read_tagged.call(null,G__42547,G__42548,G__42549));
})();
...
var vec__42565 = cljs.tools.reader.edn.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42565,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42565,(1),null);
...
var G__42618 = (((!((mret === rdr))))?cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,mret):a);
a = G__42618;
continue;
} else {
var o = (function (){var G__42568 = (function (){var G__42572 = rdr;
cljs.tools.reader.reader_types.unread(G__42572,ch);
...
var G__42570 = null;
var G__42571 = opts;
return (cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$4 ? cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$4(G__42568,G__42569,G__42570,G__42571) : cljs.tools.reader.edn.read.call(null,G__42568,G__42569,G__42570,G__42571));
})();
var G__42619 = (((!((o === rdr))))?cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,o):a);
a = G__42619;
continue;
}
}
...
var vec__42574 = cljs.tools.reader.edn.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42574,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42574,(1),null);
...
var sb = (function (){var G__42577 = (new goog.string.StringBuffer());
G__42577.append(initch);
...
var G__42622 = (function (){var G__42578 = sb;
G__42578.append(ch);

return G__42578;
})();
var G__42623 = cljs.tools.reader.reader_types.read_char(rdr);
sb = G__42622;
ch = G__42623;
continue;
}
...
while(true){
var G__42580 = ch;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__42580)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\\",G__42580)){
var G__42625 = (function (){var G__42581 = sb;
G__42581.append(cljs.tools.reader.edn.escape_char(sb,rdr));

return G__42581;
})();
var G__42626 = cljs.tools.reader.reader_types.read_char(rdr);
sb = G__42625;
ch = G__42626;
continue;
} else {
...
var G__42627 = (function (){var G__42584 = sb;
G__42584.append(ch);

return G__42584;
})();
var G__42628 = cljs.tools.reader.reader_types.read_char(rdr);
sb = G__42627;
ch = G__42628;
continue;
...
var G__42587 = rdr;
(cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$4 ? cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$4(G__42587,true,null,true) : cljs.tools.reader.edn.read.call(null,G__42587,true,null,true));
...
var temp__5733__auto__ = (function (){var G__42588 = token;
var G__42588__$1 = (((G__42588 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__42588));
if((G__42588__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__42588__$1);
}
})();
if(cljs.core.truth_(temp__5733__auto__)){
...
var G__42589 = sym;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__42589)){
return Number.NaN;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__42589)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__42589)){
...
(cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__42594,reader){
var map__42595 = p__42594;
var map__42595__$1 = (((((!((map__42595 == null))))?(((((map__42595.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42595.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42595):map__42595);
var opts = map__42595__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42595__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
...
Object.defineProperty(module.exports, "read_symbolic_value", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_symbolic_value; } });
Object.defineProperty(module.exports, "read_tagged", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_tagged; } });
Object.defineProperty(module.exports, "starting_line_col_info", { enumerable: true, get: function() { return cljs.tools.reader.edn.starting_line_col_info; } });
Object.defineProperty(module.exports, "wrapping_reader", { enumerable: true, get: function() { return cljs.tools.reader.edn.wrapping_reader; } });
Object.defineProperty(module.exports, "read_meta", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_meta; } });
Object.defineProperty(module.exports, "read_unicode_char", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_unicode_char; } });
Object.defineProperty(module.exports, "read_unmatched_delimiter", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_unmatched_delimiter; } });
Object.defineProperty(module.exports, "not_constituent_QMARK_", { enumerable: true, get: function() { return cljs.tools.reader.edn.not_constituent_QMARK_; } });
Object.defineProperty(module.exports, "read", { enumerable: true, get: function() { return cljs.tools.reader.edn.read; } });
Object.defineProperty(module.exports, "read_set", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_set; } });
Object.defineProperty(module.exports, "read_symbol", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_symbol; } });
Object.defineProperty(module.exports, "read_map", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_map; } });
Object.defineProperty(module.exports, "macros", { enumerable: true, get: function() { return cljs.tools.reader.edn.macros; } });
Object.defineProperty(module.exports, "read_namespaced_map", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_namespaced_map; } });
Object.defineProperty(module.exports, "read_list", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_list; } });
Object.defineProperty(module.exports, "dispatch_macros", { enumerable: true, get: function() { return cljs.tools.reader.edn.dispatch_macros; } });
Object.defineProperty(module.exports, "read_delimited", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_delimited; } });
Object.defineProperty(module.exports, "read_token", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_token; } });
Object.defineProperty(module.exports, "upper_limit", { enumerable: true, get: function() { return cljs.tools.reader.edn.upper_limit; } });
Object.defineProperty(module.exports, "read_dispatch", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_dispatch; } });
Object.defineProperty(module.exports, "read_string", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_string; } });
Object.defineProperty(module.exports, "escape_char", { enumerable: true, get: function() { return cljs.tools.reader.edn.escape_char; } });
Object.defineProperty(module.exports, "read_char_STAR_", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_char_STAR_; } });
Object.defineProperty(module.exports, "read_string_STAR_", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_string_STAR_; } });
Object.defineProperty(module.exports, "macro_terminating_QMARK_", { enumerable: true, get: function() { return cljs.tools.reader.edn.macro_terminating_QMARK_; } });
Object.defineProperty(module.exports, "lower_limit", { enumerable: true, get: function() { return cljs.tools.reader.edn.lower_limit; } });
Object.defineProperty(module.exports, "read_keyword", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_keyword; } });
Object.defineProperty(module.exports, "read_discard", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_discard; } });
Object.defineProperty(module.exports, "read_vector", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_vector; } });
Object.defineProperty(module.exports, "read_number", { enumerable: true, get: function() { return cljs.tools.reader.edn.read_number; } });
